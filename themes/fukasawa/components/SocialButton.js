...
const SocialButton = () => {
  ...
  const CONTACT_MAOXIANG = siteConfig('CONTACT_MAOXIANG')
      ...
      <div className='space-x-3 text-xl flex items-center text-gray-600 dark:text-gray-300 '>
        ...
        {CONTACT_MAOXIANG && (
          <a
            ...
            <i className='transform hover:scale-125 duration-150 fas fa-brands fa-mastodon dark:hover:text-green-400 hover:text-green-600' />
          </a>
        )}
      </div>
    </div>
